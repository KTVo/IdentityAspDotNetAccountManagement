...
#pragma warning restore CS8604 // Possible null reference argument.
    ...
    public async Task<UpdateAccountDetailsResponse> UpdateUserEmailAsync(ChangeEmailRequest changeEmailRequest)
    {
        ...
        User? user = await _userManager.FindByNameAsync(tokenValidateResponse.RetrievedUsername) ?? await _userManager.FindByEmailAsync(tokenValidateResponse.RetrievedEmail);
